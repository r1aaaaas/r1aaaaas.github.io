...
<head>
    ...
    <title>Jerome's Appliances | Online Shop</title>
...
<body class="index-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="admin_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Boss Jerome" data-placement="bottom" target="">
                    Jeromeappliance.com.ph
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Like us on Facebook" data-placement="bottom" href="https://www.facebook.com/malupetako08" target="_blank">
    ...
    <div class="wrapper">
        <div class="page-header">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/cover.jpg');">
            </div>
        </div>
        <br>
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 style="text-align: center;" class="title">Jerome's Products</h2>
                        <div class="typography-line">
                            <p>
                            "The most reliable appliance has simplicity and quality, does what is demanded of it, is economical to use, easy to maintain, and just as easy to repair. ...It also sells best and looks good." - Jerome M. Antiado
                            </p>
                        </div>
                        <br>
                    ...
                    <div class="tab-pane  active" id="">
                        <ul class="thumbnails">
                            ...
                            $query="SELECT * FROM products WHERE category LIKE '%$search%' OR prod_name LIKE '%$search%'";
                            ...
                            <div class="row-sm-3">
                                <div class="thumbnail">
                                    ...
                                    <center><img src="../uploads/<?php echo $res['prod_pic1']; ?>" width="300px" height="200px">
                                    <?php else: ?>
        ...
        <footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Boss Jerome
                </div>
            </div>
        </footer>
    </div>
