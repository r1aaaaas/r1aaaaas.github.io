...
if(isset($_POST['submit'])){
    ...
    if(empty($prod_name) || empty($prod_desc) || empty($prod_qty) || empty($prod_price) || empty($category) 
         || empty($prod_serial) || empty($prod_pic1) || empty($prod_pic2) || empty($prod_pic3)){    
        ...
        $query = "INSERT INTO products (prod_name, prod_desc, prod_qty, prod_price, category, prod_serial, prod_pic1, prod_pic2, prod_pic3) 
        VALUES ('$prod_name','$prod_desc','$prod_qty','$prod_price','$category','$prod_serial','$prod_pic1','$prod_pic2','$prod_pic3')";  
          ...
          <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    ...
                    <input type="text" class="form-control" id="prod_qty" name="prod_qty" placeholder="Value e.g. 123"/>
                        ...
                        <div class="input-group">
                            <select class="form-control" id="category" name="category" required>
                              <?php
                              include('../config/dbconn.php');
                              $query=mysqli_query($dbconn,"SELECT cat_name FROM category")or die(mysqli_error());
                        ...
                        <label for="prod_pic3">Picture 3 (Side View):</label>
                        <div class="input-group">
                    ...
                    <label for="prod_serial">Model:</label>
