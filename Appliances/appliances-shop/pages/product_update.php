...
{   
    ...
    if(empty($prod_name) || empty($prod_desc) || empty($prod_price) || empty($category) || empty($prod_serial)) {    
        ...
        //updating the table
        $query = "UPDATE products SET prod_name='$prod_name',prod_desc='$prod_desc',prod_price='$prod_price',
                category='$category',prod_serial='$prod_serial' WHERE prod_id=$id";
