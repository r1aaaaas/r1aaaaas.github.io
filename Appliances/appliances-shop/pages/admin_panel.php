...
<body class="profile-page sidebar-collapse">
    ...
    <!-- End Navbar -->
        ...
        <div class="wrapper">
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/cover.jpg');"></div>
                <div class="container">
        ...
        <div class="section">
            <div class="container">
                <div class="button-container">
                    ...
                    <a href="https://www.facebook.com/malupetako08" target="_blank" class="btn btn-default btn-round btn-lg btn-icon" rel="tooltip" title="Follow me on Facebook">
                                            ...
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                               ...
                                               <?php } 
                                                ...
                                                echo "<td><a href=\"product_add_qty.php?prod_id=$res[prod_id]\">Add Qty</a>
                                                 | <a href=\"product_update.php?prod_id=$res[prod_id]\">Edit</a> 
                                                 | <a href=\"product_delete.php?prod_id=$res[prod_id]\" 
                                                 onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>
                                                 | <a href=\"admin_product_details.php?prod_id=$res[prod_id]\">View</a></td>";
                                              echo "</tr>"; 
                                            }
                                          }?>
                                </table>
