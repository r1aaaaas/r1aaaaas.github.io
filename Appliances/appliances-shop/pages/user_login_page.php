    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="../index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Boss Jerome" data-placement="bottom">
                    JeromeAppliancees.com.ph
                </a>
        ...
        <footer class="footer">
            <div class="container">
                <div class="copyright">
                    ...
                    </script>,</a> Designed and Coded by Boss Jerome
                </div>
            </div>
        </footer>
    </div>
